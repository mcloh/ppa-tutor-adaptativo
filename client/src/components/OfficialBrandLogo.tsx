const OFFICIAL_LOGO_URL = "/manus-storage/ppa-teorico-logo-official-cropped_9d1ad595.webp";
const OFFICIAL_DARK_LOGO_URL = "/manus-storage/ppa-teorico-logo-dark-official_c9eda981.png";
const OFFICIAL_MARK_URL = "/manus-storage/ppa-teorico-icon-192_3067ed54.png";
